<nav class="navbar top-navbar w-100">
    <div class="container-fluid">

        <div class="navbar-left">
            <ul class="nav navbar-nav">
                <li class="ml-3 d-flex">
                    <img src="/images/logo-poliklinik.png" alt="Oculux Logo" class="img-fluid logo">
                    <p class="font-20 text-bold mt-2 mb-0 ml-2">Poliklinik</p>
                </li>
            </ul>
        </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="contents text-center">
                        <h2 class="head-title wow fadeInUp">Awesome App for Your Modern Lifestyle<br>
                            For Business, SaaS and Apps</h2>
                        <div class="header-button wow fadeInUp" data-wow-delay="0.3s">
                            <a href="https://themeforest.net/item/oculux-bootstrap-4x-admin-dashboard-clean-modern-ui-kit/23091507" class="btn btn-common">Download Now</a>
                            <a href="../html/index.html" class="btn btn-common blush">View Demo</a>
                        </div>
                    </div>
