<div class="modal fade" id="updateMedicine" tabindex="-1" role="dialog" aria-labelledby="updateMedicineLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateMedicineLabel">Add Medicine</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mx-2">
                                    ...
                                    <input type="text" class="form-control" id="otherAmountUpdate" name="otherAmount" onclick="$('#createMedicine').find('input[type=radio][name=amount]').prop('checked', false)" aria-describedby="amount">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mx-2">
                                    ...
                                    <input type="text" class="form-control" id="otherTypeUpdate" name="otherType" onclick="$('#createMedicine').find('input[type=radio][name=type]').prop('checked', false)" aria-describedby="type">
                                </div>
                            </div>
                        </div>
                    </div>
